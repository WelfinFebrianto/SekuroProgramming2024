...
(cl:defmethod cl:initialize-instance :after ((m <pesan>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'pesan)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tugas_pkg-msg:<pesan> is deprecated: use tugas_pkg-msg:pesan instead.")))

(cl:ensure-generic-function 'usia-val :lambda-list '(m))
(cl:defmethod usia-val ((m <pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugas_pkg-msg:usia-val is deprecated.  Use tugas_pkg-msg:usia instead.")
  (usia m))

(cl:ensure-generic-function 'tinggi-val :lambda-list '(m))
(cl:defmethod tinggi-val ((m <pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugas_pkg-msg:tinggi-val is deprecated.  Use tugas_pkg-msg:tinggi instead.")
  (tinggi m))

(cl:ensure-generic-function 'nama-val :lambda-list '(m))
(cl:defmethod nama-val ((m <pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugas_pkg-msg:nama-val is deprecated.  Use tugas_pkg-msg:nama instead.")
  (nama m))

(cl:ensure-generic-function 'kehadiran-val :lambda-list '(m))
(cl:defmethod kehadiran-val ((m <pesan>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugas_pkg-msg:kehadiran-val is deprecated.  Use tugas_pkg-msg:kehadiran instead.")
  (kehadiran m))
