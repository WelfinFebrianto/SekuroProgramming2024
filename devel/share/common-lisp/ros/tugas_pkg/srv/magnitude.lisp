...
(cl:defmethod cl:initialize-instance :after ((m <magnitude-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'magnitude-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tugas_pkg-srv:<magnitude-request> is deprecated: use tugas_pkg-srv:magnitude-request instead.")))

(cl:ensure-generic-function 'komponenX-val :lambda-list '(m))
(cl:defmethod komponenX-val ((m <magnitude-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugas_pkg-srv:komponenX-val is deprecated.  Use tugas_pkg-srv:komponenX instead.")
  (komponenX m))

(cl:ensure-generic-function 'komponenY-val :lambda-list '(m))
(cl:defmethod komponenY-val ((m <magnitude-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugas_pkg-srv:komponenY-val is deprecated.  Use tugas_pkg-srv:komponenY instead.")
  (komponenY m))

(cl:ensure-generic-function 'komponenZ-val :lambda-list '(m))
(cl:defmethod komponenZ-val ((m <magnitude-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugas_pkg-srv:komponenZ-val is deprecated.  Use tugas_pkg-srv:komponenZ instead.")
  (komponenZ m))
...
(cl:defmethod cl:initialize-instance :after ((m <magnitude-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'magnitude-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tugas_pkg-srv:<magnitude-response> is deprecated: use tugas_pkg-srv:magnitude-response instead.")))

(cl:ensure-generic-function 'magnitude-val :lambda-list '(m))
(cl:defmethod magnitude-val ((m <magnitude-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tugas_pkg-srv:magnitude-val is deprecated.  Use tugas_pkg-srv:magnitude instead.")
  (magnitude m))
